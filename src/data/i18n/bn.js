  ...
  wizard: {
    ...
    questions: {
      ...
      horizon: {
        ...
        months: 'মাস',
        years: 'বছর',
        hint: 'কমপক্ষে একটি শূন্যের বেশি মান দিন',
        summary: 'এটি প্রায়',
        categories: { short: 'স্বল্পমেয়াদি (১ বছরের কম)', medium: 'মধ্যমেয়াদি (১-৩ বছর)', long: 'দীর্ঘমেয়াদি (৩+ বছর)' },
      },
      budget: {
      ...
      stockCount: {
        title: 'আপনি কতগুলো স্টক চান?',
        subtitle: 'আপনার পোর্টফোলিওর জন্য স্টক সংখ্যা নির্বাচন করুন।',
      },
      goal: {
